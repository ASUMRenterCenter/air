...
*/
  ...
  componentDidUpdate() {
    if (this.state.organization.length > 0 && !this.state.org_update && this.state.phones.length > 0 && this.state.services.length > 0){
      this.setState({
        ...
        organizationPhoneDescription: this.state.phones[0].fields["description"],
        servicesNames: this.state.services[0].fields["Name"],
        org_update: true
      })
    } else if ((this.state.organization.length > 0) && !this.state.org_update && this.state.phones.length == 0){
      this.setState({
        organizationName: this.state.organization[0].fields["name"],
        organizationDescription: this.state.organization[0].fields["description"],
        organizationEmail: this.state.organization[0].fields["email"],
  ...
  handleIndexedChange(e, index) {
    ...
    console.log(":LSKDJF:LKDSJF:LKSDFJ:DSLFKJSD:LFKJSD:LFKJSD:LKFJSD:LKFJS:DLKFj");
  }
  ...
  render() {
        ...
        {this.state.phones.length > 0 ? (
          ...
          <div className ="container mt-3" key={phones.id}>
            <PhoneEditFields {...phones.fields} handleChange={this.handleChange} handleSubmit={this.handleSubmit}/>
          </div>
          )
        ):("")
        }
        {this.state.services.length > 0 ? (
          ...
          <div className ="container mt-3" key={index}>
            <ServiceEditFields {...services.fields} index={index} handleIndexedChange={this.handleIndexedChange} handleSubmit={this.handleSubmit}/>
          </div>
          )
        ):("")
        }
